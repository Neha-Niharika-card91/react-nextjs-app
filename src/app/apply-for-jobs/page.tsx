    ...
    <div className="justify-content-center overflow-auto">
      <div className="container-fluid d-flex flex-row align-items-center justify-content-evenly w-100">
        ...
        <div className="text-center d-flex flex-row">
          ...
          {details.name != "" && <CheckCircle2 className="mt-3" />}
          <p className="mt-3">Personal Details</p>
        </div>
      </div>
      {details.name != "" && (
        <div className="container d-flex flex-column justify-content-center align-items-center border p-2 bg-dark text-light">
          <ThumbsUp size={50} />
